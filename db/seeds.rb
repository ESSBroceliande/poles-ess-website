...
Setting.pole_mail = "coordination@ess-broceliande.bzh"                    if Setting.pole_mail.blank?
...
Setting.admin_emails = %w[bonjour@lassembleuse.fr coordination@ess-broceliande.bzh coordination@broceliande-richesses-associatives.org mathilde.herault@broceliande-richesses-associatives.org]    if Setting.admin_emails.blank?
